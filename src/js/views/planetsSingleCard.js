...
export const PlanetsSingleCard = () => {
          ...
          <div className="card big">
            ...
            <div className="card-body">
              ...
              <div className="d-flex justify-content-between align-items-center bg-light">
                ...
                <p className="ms-2">Diameter: {dataDetails.diameter}</p>
                <p className="ms-2">Priod orbital: {dataDetails.orbital_period}</p>
                <p className="ms-2">Population: {dataDetails.population}</p>
              </div>
            </div>
          </div>
        </div>
